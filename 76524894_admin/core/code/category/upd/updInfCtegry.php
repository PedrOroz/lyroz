    ...
    try
    {
        ...
        if(!isset($_SESSION['id_user_dao']) || empty($_SESSION['id_user_dao'])){
            ...
            exit();
                ...
                {
                    if(!isset($_POST['par1']) || !isset($_POST['title_category_lang']))
                    {
                        $valor = array("estado" => "false",
                        ...
                        exit();
                            ...
                            $id_category_lang       = intval(trim($_POST['par1']));
                            $title_category_lang    = addslashes(trim($_POST['title_category_lang']));

                            if(!empty($id_category_lang) && !empty($title_category_lang))
                            {
                                ...
                                categoriesController::updateInformationCategory($id_category_lang,$title_category_lang,$subtitle_category_lang,$description_small_category_lang,$description_large_category_lang,$color_hexadecimal_category);
                            }else{
                                    $valor = array("estado" => "false",
