                ...
                if($_SERVER["REQUEST_METHOD"] == "POST")
                {
                    if(!isset($_POST['par1']) || !isset($_POST['par2']) || !isset($_POST['par3']) || !isset($_POST['par4']))
                    {
                        ...
                        exit();
                            ...
                            if(!empty($_FILES['fileInputChangeVersion']['name']))
                            {
                                ...
                                if(!empty($id_image_lang_version) && !empty($title_image_lang) && !empty($id_type_image) && !empty($id_lang) && !empty($file_name))
                                {
                                    ...
                                    imageController::updateImageByImageLangVersionIdWithoutLanguage($id_image_lang_version,$title_image_lang,$id_type_image,$id_lang,$file_error,$file_name,$file_type,$file_tmp_name,$file_size);
                                }else{
                                        $valor = array("estado" => "false",
