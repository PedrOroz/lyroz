                    ...
                    if(!isset($_POST['par1']) || !isset($_POST['par2']) || !isset($_POST['par3']) || !isset($_POST['par4']) || !isset($_POST['par5']) || !isset($_POST['id_type_version']))
                    {
                        ...
                        exit();
                            ...
                            if(isset($_FILES['fileInputUploadVersion']['name']))
                            {
                                ...
                                //EL ID LANG SOLO ES OBLIGATORIO CUANDO SE REGISTRA LA VERSION DE LA IMAGEN EN UN SOLO IDIOMA, EN NUESTRO CASO SI ES NECESARIO
                                ...
                                if(!empty($id_image) && !empty($id_image_lang) && !empty($id_lang) && !empty($title_image_lang) && !empty($id_type_image) && !empty($id_type_version) && !empty($file_name))
                                {
                                    ...
                                    imageController::uploadImageVersionInASingleLanguageByImageLangId($id_image,$id_image_lang,$id_lang,$title_image_lang,$id_type_image,$id_type_version,$file_error,$file_name,$file_type,$file_tmp_name,$file_size);
                                }else{
                                        $valor = array("estado" => "false",
