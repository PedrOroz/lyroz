    ...
    try
    {
        ...
        if(!isset($_SESSION['id_user_dao']) || empty($_SESSION['id_user_dao'])){
            ...
            exit();
                ...
                {
                    if(!isset($_POST['par1']) || !isset($_POST['par2']) || !isset($_POST['par3']) || !isset($_POST['title_image_lang']) || !isset($_POST['id_menu']))
                    {
                        $valor = array("estado" => "false",
                        ...
                        exit();
                            ...
                            if(!empty($id_menu) && !empty($id_image) && !empty($id_image_lang) && !empty($id_lang) && !empty($title_image_lang))
                            {
