        ...
        if(!isset($_SESSION['id_user_dao']) || empty($_SESSION['id_user_dao'])){
            ...
            exit();
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					if(!isset($_POST['par1']) || !isset($_POST['name_user']) || !isset($_POST['last_name_user']) || !isset($_POST['gender_user']))
					{
						$valor = array("estado" => "false",
						...
						exit();
							...
							if(!empty($id_user) && !empty($id_role) && !empty($name_user) && !empty($last_name_user) && !empty($gender_user))
							{
