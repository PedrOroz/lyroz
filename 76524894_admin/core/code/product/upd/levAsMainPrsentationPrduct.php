                ...
                if($_SERVER["REQUEST_METHOD"] == "POST")
                {
                    if(!isset($_POST['par8']))
                    {
                        ...
                        exit();
                            ...
                            $id_product_lang_presentation_image_lang  = intval(trim($_POST['par8']));

                            if(!empty($id_product_lang_presentation_image_lang)){

                                require_once($slash.'controllers/functions/productPresentationsController.php');

                                productPresentationsController::leaveAsMainPresentationProduct($id_product_lang_presentation_image_lang);
                            }else{
                                    $valor = array("estado" => "false",
