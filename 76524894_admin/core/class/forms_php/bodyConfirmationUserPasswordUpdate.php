<?php
  $bodyConfirmationUserPasswordUpdate = '<!DOCTYPE html>
...
$bodyConfirmationUserPasswordUpdate .= '<tr>
...
$bodyConfirmationUserPasswordUpdate .= (!empty($EMAIL) ? '<p style="margin:0;font-size:14px;line-height:20px;color:#ffffff"><strong>'.$lang_global["Correo electrónico"].':</strong> <a href="mailto:'.$EMAIL.'" target="_blank" style="color: #ffffff;text-decoration:none;">'.$EMAIL.'</a></p>' : '');

$bodyConfirmationUserPasswordUpdate .= (!empty($PASSWORD) ? '<p style="margin:0;font-size:14px;line-height:20px;color:#ffffff"><strong>'.$lang_global["Contraseña"].':</strong> '.$PASSWORD.'</p>' : '');

$bodyConfirmationUserPasswordUpdate .= '</td>
                </tr>';
                }
