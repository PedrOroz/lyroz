...
var defaultOptions = {
   ...
   */
  dictDefaultMessage: "Colocar archivos aquí para subir",

  /**
   * The text that replaces the default message text it the browser is not supported.
   */
  dictFallbackMessage: "Su navegador no soporta cargas de archivos drag'n'drop.",
   ...
   * be ignored.
   */
  dictFallbackText: "Por favor, utilice el siguiente formulario de reserva para subir sus archivos como en los viejos tiempos.",
