                ...
                if($_SERVER["REQUEST_METHOD"] == "POST")
                {
                    if(isset($_FILES['file']['name']))
                    {
                        ...
                        if(!empty($id_type_image) && !empty($file_name))
                        {
                            ...
                            $title_image_lang   = addslashes(trim(WEBSITE));
                            ...
                            imageController::uploadSummernoteImage($id_type_image,$title_image_lang,$file_error,$file_name,$file_type,$file_tmp_name,$file_size,1);
                        }else{
