...
var Detector = __webpack_require__(/*! ./detector */ "./node_modules/detector/web/detector.js");
var WebRules = __webpack_require__(/*! ./web-rules */ "./node_modules/detector/web/web-rules.js");
...
var win = typeof window === "undefined" ? __webpack_require__.g : window;
...
(() => {
/*!************************************!*\
  !*** ./assets/js/common-mobile.js ***!
  \************************************/
var detector = __webpack_require__(/*! detector */ "./node_modules/detector/web/web-detector.js");
var ua = detector.parse(navigator.userAgent);
if (ua.device.name === 'iphone' || ua.device.name === 'ipad' || ua.device.name === 'android' || ua.device.name === 'blackberry' || ua.device.name === 'wp' || ua.device.name === 'mi' || ua.device.name === 'meizu' || ua.device.name === 'nexus' || ua.device.name === 'nokia' || ua.device.name === 'samsung' || ua.device.name === 'aliyun' || ua.device.name === 'huawei' || ua.device.name === 'lenovo' || ua.device.name === 'zte' || ua.device.name === 'vivo' || ua.device.name === 'htc' || ua.device.name === 'oppo' || ua.device.name === 'konka' || ua.device.name === 'sonyericsson' || ua.device.name === 'coolpad' || ua.device.name === 'lg' || ua.device.name === 'alcatel') {
  //console.log(url_mobil);
  document.location = url_mobil;
}
})();
