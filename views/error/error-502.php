  		...
  		<main>
			<div class="container-fluid mt-main-header">
	  			<div class="d-sm-flex justify-content-center align-items-center text-center" id="main">
				    <h1 class="mr-3 pr-3 align-top border-right inline-block align-content-center">502</h1>
				    <div class="inline-block align-middle">
				    	<h2 class="ms-3 font-weight-normal lead" id="desc"><?php echo LANG_ERROR_502; ?></h2>
				    </div>
				</div>
	  		</div>
	  	</main>
