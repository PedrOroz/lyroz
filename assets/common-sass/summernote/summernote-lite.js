...
external_jQuery_default().fn.extend({
  ...
  summernote: function summernote() {
    ...
    options.langInfo = external_jQuery_default().extend(true, {}, (external_jQuery_default()).summernote.lang["es-ES"], (external_jQuery_default()).summernote.lang[options.lang]);
...
(external_jQuery_default()).summernote = external_jQuery_default().extend((external_jQuery_default()).summernote, {
  ...
  lists: lists,
  options: {
    langInfo: (external_jQuery_default()).summernote.lang["es-ES"],
    editing: true,
    modules: {
      'editor': Editor,
      'clipboard': Clipboard,
